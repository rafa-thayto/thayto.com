...
modifiedTime: '2022-06-21T15:14:48Z'
description: 'Como configurar o deploy do Turborepo no Netlify.'
image:
...
Um dia desses passei por uma dificuldade que foi fazer o deploy de uma aplicação
minha utilizando Turborepo com Next.js e como acredito que mais pessoas possam ter
esse problema, resolvi fazer um guia de como fazer as configurações iniciais, bora
lá?
