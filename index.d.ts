...
export type TrackedProperties = {
   ...
   *
   * @description extracted from `window.navigator.language`
   * @example 'https://app.simplytics.cloud/docs/getting-started'
   */
  referrer: string
...
export type SimplyticsTracker = {
  track: {
     ...
     *
     * @example ```
     * simplytics.track('signup-button');
     * ```
     */
     ...
     *
     * @example ```
     * simplytics.track('signup-button', { name: 'newsletter', id: 123 });
     * ```
     */
     ...
     *
     * @example ```
     * simplytics.track({ website: 'e676c9b4-11e4-4ef1-a4d7-87001773e9f2', url: '/home', title: 'Home page' });
     * ```
     */
     ...
     *
     * @example ```
     * simplytics.track((props) => ({ ...props, url: path }));
     * ```
     */
